            ...
            <div id="content">
				...
				<div class="container">
					...
					<tbody><?php
							...
							<tr>
						<td valign="top"><br>
							<a href="<?php echo base_url().'index.php/Admin/Admin/index_edit/'.$data->id.'' ?>" class="btn btn-success">Edit Data</a>
						...
						<table border="0" width="100%" style="padding-left: 2px; padding-right: 13px;">
							<tbody>
								...
								<td width="2%">:</td>
								<td style="color: rgb(118, 157, 29); font-weight:bold"><?php echo $data->nama ?></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td valign="top">:</td>
									<td><?php echo $data->nama_sekolah1 ?></td>
								</tr>
								<tr>
									<td class="textt">Nama Sekolah SMP</td>
									<td valign="top">:</td>
									<td><?php echo $data->nama_sekolah2 ?></td>
								</tr>
								<tr>
									<td class="textt">Nama Sekolah SMA</td>
									<td valign="top">:</td>
									<td><?php echo $data->nama_sekolah3 ?></td>
								</tr>
								<tr>
									<td class="textt">Tamat Sekolah SD</td>
									<td valign="top">:</td>
									<td><?php echo $data->tamat_sekolah1 ?></td>
								</tr>
								<tr>
									<td class="textt">Tamat Sekolah SMA</td>
									<td valign="top">:</td>
									<td><?php echo $data->tamat_sekolah2 ?></td>
								</tr>
								<tr>
									<td class="textt">Tamat Sekolah SMA</td>
									<td valign="top">:</td>
									<td><?php echo $data->tamat_sekolah3 ?></td>
								</tr>
								<tr>
								<td></td>
								</tr>
